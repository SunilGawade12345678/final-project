...
@Entity
@Table(name="user_merchant_details")
public class UserMerchant {
	...
	public UserMerchant(int id, String name, String marketingName, String address, String city, String state,
			int pincode, long mobileNo, String landlineNo, String partner, String owner, String category, int mcc,
			String mccdesc, String typeOfIntegration, String addMerchantOption, String vpa, String gstNumber,
